...
public class GameManager : MonoBehaviour
{
    ...
    public List<EnemyEntity> enemies1,enemies2,enemies3,enemies4,enemies5,enemies6,enemies7;
    public List<Item> items1,items2,items3,items4,items5,items6,items7;
